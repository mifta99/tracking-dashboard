...
class CreatePuskesmasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('puskesmas', function (Blueprint $table) {
            ...
            $table->string('no_hp_pic_dinkes_prov')->nullable();
            $table->string('jabatan_pic_dinkes_prov')->nullable();
            $table->string('pic_dinkes_kab')->nullable();
            $table->string('no_hp_pic_dinkes_kab')->nullable();
            $table->string('jabatan_pic_dinkes_kab')->nullable();
